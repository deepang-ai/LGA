...
class Ethident(torch.nn.Module):
    def __init__(self,  out_channels,
                 encoder, use_proj_head=True, temperature=0.2, dropout=0.2):
        ...
        self.fc = Sequential(Linear(self.embedding_dim * 4 , self.embedding_dim),
    ...
    def forward(self, data):
        ...
        node_reps, graph_reps = self.encoder(x, edge_index, batch)

        pred_out = self.fc(node_reps)
